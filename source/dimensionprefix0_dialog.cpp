...
#include "ui_dimensionprefix0_dialog.h"


DimensionPrefix0_Dialog::DimensionPrefix0_Dialog(HANDLE parent, HANDLE rcparent, int f):
	DimensionPrefix0_Dialog((QWidget *)parent, (Dialog *)rcparent, (Qt::WindowFlags) f)
{}
DimensionPrefix0_Dialog::DimensionPrefix0_Dialog(QWidget *parent, Dialog *rcparent, Qt::WindowFlags f) :
    //QWidget(parent)
    RCDialog(rcparent,parent,f),
    ui(new Ui::DimensionPrefix0_Dialog)
{
    ui->setupUi(this);
    ...
    ((PEntryDisplayDialogControl*)RCdlg->getcontrol(103))->setQW(ui->_103);
    ((PEntryDisplayDialogControl*)RCdlg->getcontrol(103))->sethwnd(ui->_103);
    ...
    else
    {
        ...
        ui->_104->hide();
        ui->PrefixLabel->setVisible(true);
        ui->PrefixLabel->show();
        lastText = ui->_102->toPlainText();
        ui->_102->setPlainText(lastText);
    }
...
DimensionPrefix0_Dialog::~DimensionPrefix0_Dialog()
{
    delete ui;
}

void DimensionPrefix0_Dialog::on__100_clicked(bool checked)
{
...
void DimensionPrefix0_Dialog::on__101_clicked(bool checked)
{
    // using the dialog callback function
    UINT msg;
    WPARAM wParam;
...
void DimensionPrefix0_Dialog::on__102_textChanged()
{
...
void DimensionPrefix0_Dialog::on__104_clicked(bool checked)
{
    if(checked)
    {
         ui->_102->setPlainText(lastText);
...
void DimensionPrefix0_Dialog::on_accept()
{
    // using the dialog callback function
    UINT msg;
    WPARAM wParam;
...
void DimensionPrefix0_Dialog::drawSample()
{
    if((PEntryDisplayDialogControl*)RCdlg->getcontrol(103));
        ((PEntryDisplayDialogControl*)RCdlg->getcontrol(103))->draw(RCdlg,0);
