  ...
  if (event->isa(EntitySelected))
    {  if (! ((EntitySelectedEvent *)event)->getaddtoselection())
       ...
       if ((((EntitySelectedEvent *)event)->getaddtoselection()%10) == 1 && inlist)
         ...
         {
            selection.add(((EntitySelectedEvent *)event)->getentity());
            if (! (((EntitySelectedEvent *)event)->getentity())->getselected())
                (((EntitySelectedEvent *)event)->getentity())->highlight();  //  Don't reselect it
