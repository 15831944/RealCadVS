/********************************************************************************
** Form generated from reading UI file 'DIMENSION_DIALOG_v7.ui'
**
...
#ifndef UI_DIMENSION_DIALOG_V7_H
#define UI_DIMENSION_DIALOG_V7_H
...
public:
    ...
    void setupUi(QDialog *Dimension_Dialog)
    {
        ...
        Dimension_Dialog->resize(453, 584);
        Dimension_Dialog->setMinimumSize(QSize(0, 0));
        Dimension_Dialog->setMaximumSize(QSize(100000, 100000));
        QFont font;
        ...
        _214 = new QGraphicsView(Dimension_Dialog);
        _214->setObjectName(QString::fromUtf8("_214"));
        _214->setGeometry(QRect(18, 386, 313, 159));
        _214->setMinimumSize(QSize(313, 159));
        _214->setMaximumSize(QSize(313, 159));
        _214->setFont(font);
        ...
        _228 = new QPushButton(Dimension_Dialog);
        _228->setObjectName(QString::fromUtf8("_228"));
        _228->setGeometry(QRect(344, 382, 100, 23));
        _228->setFont(font1);
        _228->setAutoDefault(false);
        _229 = new QPushButton(Dimension_Dialog);
        _229->setObjectName(QString::fromUtf8("_229"));
        _229->setGeometry(QRect(344, 408, 100, 23));
        _229->setFont(font1);
        _229->setAutoDefault(false);
        _230 = new QPushButton(Dimension_Dialog);
        _230->setObjectName(QString::fromUtf8("_230"));
        _230->setGeometry(QRect(344, 434, 100, 23));
        _230->setFont(font1);
        _230->setAutoDefault(false);
        _231 = new QPushButton(Dimension_Dialog);
        _231->setObjectName(QString::fromUtf8("_231"));
        _231->setGeometry(QRect(344, 470, 100, 23));
        _231->setFont(font1);
        _231->setAutoDefault(false);
        _232 = new QPushButton(Dimension_Dialog);
        _232->setObjectName(QString::fromUtf8("_232"));
        _232->setGeometry(QRect(344, 496, 100, 23));
        _232->setFont(font1);
        _232->setAutoDefault(false);
        _233 = new QPushButton(Dimension_Dialog);
        _233->setObjectName(QString::fromUtf8("_233"));
        _233->setGeometry(QRect(344, 522, 100, 23));
        _233->setFont(font1);
...
#endif // UI_DIMENSION_DIALOG_V7_H
