/********************************************************************************
** Form generated from reading UI file 'FIGURE_DIALOG_v8x.ui'
**
...
#ifndef UI_FIGURE_DIALOG_V8X_H
#define UI_FIGURE_DIALOG_V8X_H
...
public:
    ...
    void setupUi(QDialog *Figure_Dialog)
    {
        ...
        Figure_Dialog->resize(840, 415);
        Figure_Dialog->setMinimumSize(QSize(840, 415));
        Figure_Dialog->setMaximumSize(QSize(840, 415));
        QFont font;
        font.setPointSize(10);
        Figure_Dialog->setFont(font);
        _1 = new QPushButton(Figure_Dialog);
        _1->setObjectName(QString::fromUtf8("_1"));
        _1->setGeometry(QRect(658, 380, 75, 23));
        QFont font1;
        ...
        _115->setGeometry(QRect(166, 170, 183, 21));
        _115->setFont(font);
        ...
        _121->setGeometry(QRect(82, 254, 241, 20));
        ...
        _122->setGeometry(QRect(330, 252, 55, 21));
        ...
        _124->setGeometry(QRect(64, 170, 105, 21));
        _124->setFont(font);
        ...
        _123->setGeometry(QRect(418, 22, 413, 223));
        _123->setMinimumSize(QSize(413, 223));
        _123->setMaximumSize(QSize(413, 223));
        ...
        groupBox_2->setGeometry(QRect(418, 250, 413, 123));
